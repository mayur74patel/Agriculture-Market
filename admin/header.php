        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-lg"><b>Agriclture Market website ADMIN</b></span>
                </a>
...
<li><a href="request_list.php" class="notif"><span class="num"><?php echo($count);?></span></a>
</li>
<?php
					global $conn;
    $select_query_12 = "SELECT * FROM order_1";
    $select_res_12 = mysqli_query($conn, $select_query_12);
    $count_1=mysqli_num_rows($select_res_12); 
    
					?>
<li><a href="order_list.php" class="notif_1"><span class="num"><?php echo($count_1);?></span></a>
</li>
