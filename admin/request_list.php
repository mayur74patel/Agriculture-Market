...
include 'sidebar.php';
$category_data = array();
$category_data = getAllrental_requestData();
?>
<style>
                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
										...
										echo "<td>" . $val['implement_required'] . "</td>";
										echo "<td>" . $val['created_at'] . "</td>";
                                        
                                        echo "<td><a href='requestdelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Remove</a></td>&nbsp;&nbsp;";//<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
