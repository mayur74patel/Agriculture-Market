...
include 'sidebar.php';
$category_data = array();
$category_data = getAllfeedbackData();
?>
<style>
                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td>".$val['user_id'].
	"</td>";
										echo "<td>" . $val['feedback_detail'] . "</td>";
										echo "<td>" . $val['created_at'] . "</td>";
                                        
                                        echo "<td><a href='admindelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Remove</a></td>&nbsp;&nbsp;";//<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
